...
<head>
    <meta charset="UTF-8">
    <title>ЗАГС</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <footer>
      <div class="wrapper web-mobile a_items flex_sp">
          ...
          <div class=" w250">
              <p class="rec_time">
                Прием документов             </p>
              <p class="c7 fs_14 m_t10">Понедельник, Вторник, Среда, Пятница, Суббота</p>
          ...
          <div class="w350">
              <ul class="footer_contact">
                  ...
                  <li class="d_flex m_b15">
                      ...
                      <div class="c7 fw_300"><p> Туркменистан, г. Ашхабад, Беркарарлык етрап, Гурбансолтан эдже шаёлы, дом 186</p>
  </div>
                  </li>
              </ul>
          </div>
      ...
      <div class="wrapper d_flex flex_sp foot2">
          <div class="d_flex">
              <p class="c_white">Copyright &copy; 2022. Все права зашищены. By Nurmuhammedov</p>
          </div>
          <div class="c_white">
