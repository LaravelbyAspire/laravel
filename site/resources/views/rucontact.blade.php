...
<div class="m_t150">
    <div class="wrapper">
        <div class="chap_title">Контакты</div>
        <hr class="m_20_0 hg2">
        <div class="timetable">
            <table>
	<tbody>
		<tr>
			<td class="table_header" colspan="4">График работы приёмной</td>
		</tr>
		<tr>
			<td class="fw_bold w25 p_20_30">Дни недели</td>
			<td class="fw_bold w25 p_20_30">Подачи готовых документов</td>
			<td class="fw_bold w25 p_20_30">Принятие документов от граждан</td>
			<td class="fw_bold w25 p_20_30">Обед</td>
		</tr>
		<tr>
			<td>Понедельник</td>
			<td>09:00-13:00</td>
      <td>14:00-16:00</td>
		...
		<tr>
			<td>Четверг</td>
      	<td colspan="3">День профилактики</td>
    ...
    <td>13:00-14:00</td>
		...
		<tr>
			<td>Воскресение</td>
			<td colspan="3">Не рабочий день</td>
		</tr>
	</tbody>
</table>
</div>
        ...
        <div class="m_40_0 web-mobile w100 ">
                  ...
                  @csrf
                    <div class="d_flex flex_wrap">
                        ...
                        <div class="sendbtn w49 inputs">
                            <input class="input_send" type="submit" name="send" value="Отправить">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="contact_inform p20">
                <div class="inform_header c3 fs_25 fw_bold ln_30 m_t5">Связаться</div>
                <ul class="m_80_0 footer_contact">
                    ...
                    <li class="d_flex m_b40">
                        ...
                        <div class="c7 fw_bold"><p>Туркменистан, г. Ашхабад, Беркарарлык етрап, Пр Гурбансолтан эдже, дом 186</p>
</div>
                    </li>
                </ul>
            </div>
